...
public class ProjectsTest extends testBase {
	...
	@Test
	public void verifyGroupByOptionsInProjectPage() {
		...
		myProfilePage.selectProjectMainMenu();
		extentTest.log(Status.INFO, "Clicked on Project Main Menu");
		
		myProfilePage.clickOnProjectSubMenu();
		extentTest.log(Status.INFO, "click on project submenu");
